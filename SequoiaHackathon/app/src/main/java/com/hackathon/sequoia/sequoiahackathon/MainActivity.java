...
public class MainActivity extends ActionBarActivity
    ...
    private void addHomeScreenFragment() {
        /*
        setSearchMenu(true);
        setTitleView(getString(R.string.home));
        setDrawerIndicator(true);
        mBannerScreenFragment = BannerScreenFragment.newInstance();
        getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.container, mBannerScreenFragment,
                        BannerScreenFragment.TAG).commitAllowingStateLoss();*/
    }
